...
-- Description:	Report Data of Metabolic Survey(Twice a Year) for Person List
-- =============================================
ALTER PROCEDURE Report.sp_Metabolic_PersonListForm_GetTwiceAYearReportData
...
BEGIN
	...
	, [PersonShortAddress] = tbHome.HomeNO + ' Á.' + tbHospital.MooNo
	...
	AND (
		...
		OR tbDetailInfo.RowGUID IS NULL 
	)
	AND (
