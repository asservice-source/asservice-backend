...
-- Description:	Monthly Report Data for Mosquito HICI (House Index, Container Index) : Form #6 HICI Summary of Country
-- =============================================
ALTER PROCEDURE Report.sp_HICI_Mosquito_Form6_HICISummaryForCountry_GetMonthlyReportData
...
BEGIN
	...
	, [ProvinceCodeOfDetailInfo] = tbProvinceOfDetailInfo.Code 
	, [ProvinceNameOfDetailInfo] = tbProvinceOfDetailInfo.Name
					...
					LEFT JOIN dbo.Home AS tbHome ON tbDetailInfo.HomeID = tbHome.ID
						...
						LEFT JOIN dbo.Village AS tbVillageOfDetailInfo ON tbHome.VillageID = tbVillageOfDetailInfo.ID 
							LEFT JOIN dbo.Hospital AS tbHospitalOfDetailInfo ON tbVillageOfDetailInfo.HospitalCode = tbHospitalOfDetailInfo.Code5
								...
								LEFT JOIN dbo.Province AS tbProvinceOfDetailInfo ON tbHospitalOfDetailInfo.ProvinceCode = tbProvinceOfDetailInfo.Code
