...
-- Description:	Additional Information for Report - Monthly Report Data for Mosquito HICI (House Index, Container Index) : Form #5 - Summary for Province
-- =============================================
ALTER PROCEDURE Report.sp_HICI_Mosquito_Form5_HICISummaryForProvince_GetReportInformation
