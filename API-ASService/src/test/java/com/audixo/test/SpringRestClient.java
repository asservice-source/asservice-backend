...
import com.fwg.asservice.model.AuthTokenInfo;
import com.fwg.asservice.model.UserLogin;
  
public class SpringRestClient {
  
    public static final String REST_SERVICE_URI = "http://localhost:8080/API-ASService";
     
    public static final String AUTH_SERVER_URI = "http://localhost:8080/API-ASService/oauth/token";
     
    public static final String QPM_PASSWORD_GRANT = "?grant_type=password&username=anamai01&password=an123401";
    ...
    private static HttpHeaders getHeadersWithClientCredentials(){
        String plainClientCredentials="asservice-trusted-client:secret";
    ...
    private static void getUser(AuthTokenInfo tokenInfo){
        ...
        RestTemplate restTemplate = new RestTemplate();
        HttpEntity<String> request = new HttpEntity<String>(getHeaders());
        ResponseEntity<UserLogin> response = restTemplate.exchange(REST_SERVICE_URI+"/user/1"+QPM_ACCESS_TOKEN+tokenInfo.getAccess_token(),
                HttpMethod.GET, request, UserLogin.class);
        UserLogin user = response.getBody();
    ...
    private static void updateUser(AuthTokenInfo tokenInfo) {
        ...
        UserLogin user  = new UserLogin();
        HttpEntity<Object> request = new HttpEntity<Object>(user, getHeaders());
        ResponseEntity<UserLogin> response = restTemplate.exchange(REST_SERVICE_URI+"/users/1"+QPM_ACCESS_TOKEN+tokenInfo.getAccess_token(),
                HttpMethod.PUT, request, UserLogin.class);
    ...
    private static void deleteUser(AuthTokenInfo tokenInfo) {
        ...
        restTemplate.exchange(REST_SERVICE_URI+"/user/3"+QPM_ACCESS_TOKEN+tokenInfo.getAccess_token(),
                HttpMethod.DELETE, request, UserLogin.class);
    }
